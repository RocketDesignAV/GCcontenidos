...
const Menu = () => {
  ...
  const [claseBg] = useState('claseBgStart');
  const [claseTex] = useState('claseTextStart');
  ...
  */
  ...
  return (
    ...
    <header className="bg-white border-gray-200 dark:bg-gray-900">
      <div className={`fixed navDivi flex items-center justify-between xl:max-w-10xl xl:mx-auto max-w-full lg:p-5 flex-wrap w-full back ${claseBg}`}>
